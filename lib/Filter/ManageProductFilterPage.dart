...
import 'ManageProductFilter.dart';

class ManageProductFilterPage extends StatefulWidget {
  ManageProductFilterPage({Key key, this.filter}) : super(key: key);
...
class _ManageProductPageButton1State extends State<ManageProductFilterPage> {
  @override
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Transform.translate(
                offset: Offset(
                    MediaQuery.of(context).size.width.toDouble() - 55, 60.0),
                child: IconButton(
                    icon: Image.asset(
