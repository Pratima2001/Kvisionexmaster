...
import 'package:kvmaster/EditButtonPages/ManagePartEditButton.dart';
import 'package:kvmaster/Filter/ManagePartFilter.dart';
import 'package:kvmaster/OnButtonClickPages/ManagePartButton.dart';

class ManagePartFilterPage extends StatefulWidget {
  ManagePartFilterPage({Key key, this.filter}) : super(key: key);
...
class _State extends State<ManagePartFilterPage> {
  @override
          ...
          child: FloatingActionButton(
              ...
              onPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (_) => ManagePartButton()));
              }),
        ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Transform.translate(
                offset: Offset(
                    MediaQuery.of(context).size.width.toDouble() - 55, 40.0),
                child: IconButton(
                    icon: Image.asset(
                      ...
                      Container(
                          ...
                          child: StreamBuilder(
                            stream: FirebaseFirestore.instance
                                .collection("ProductPartMaster")
                                .orderBy(widget.filter, descending: false)
                                .snapshots(),
