...
import 'ManagePartFilterPage.dart';

class ManagePartFilter extends StatefulWidget {
  ManagePartFilter({
    Key key,
  }) : super(key: key);
...
class _ManageProductPageButton1State extends State<ManagePartFilter> {
  bool val = true;
