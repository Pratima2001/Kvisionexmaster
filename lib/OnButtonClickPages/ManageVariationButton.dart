...
class ManageVariationButton extends StatefulWidget {
  @override
  _ManageVariationButtonState createState() => _ManageVariationButtonState();
}

class _ManageVariationButtonState extends State<ManageVariationButton> {
                          ...
                          children: <Widget>[
                            Pinned.fromSize(
                              ...
                              child: GestureDetector(
                                onTap: (){
                                  print("save");
                                  FirebaseController.instanace.productVariationMaster(_varitionName.text,_varitionName.text,_size.text,selected).then((data) async {
                                    print(data);
                                    if(data==null){
