...
class ManageTypeButton extends StatefulWidget {
...
class _State extends State<ManageTypeButton> {
          ...
          child: Column(
            ...
            children: [
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromSize(
                        bounds: Rect.fromLTWH(16.0, 47.0, 249.0, 20.0),
                        size: Size(352.0, 81.0),
                        pinLeft: true,
                        fixedWidth: true,
                        fixedHeight: true,
              ...
              Row(
                children: [
                  Padding(
                    padding: EdgeInsets.fromLTRB(257, 90, 0, 0),
                    child: Container(
                      height: 70,
                      width: 70,
                      decoration: BoxDecoration(
                      ...
                      child: IconButton(
                        onPressed: (){
                          print("0");
                          FirebaseController.instanace.productTypeMaster(_productName.text,_productName.text,_productNameInTamil.text,_bodies,_variations).then((data) async {
                            print(data);
                            if(data==null){
