...
import 'package:kvmaster/EditButtonPages/ManageBodiesEditButton.dart';
import 'package:kvmaster/OnButtonClickPages/ManageBodiesButton.dart';


class ManageBodies extends StatefulWidget {
  ManageBodies({
    Key key,
  }) : super(key: key);
...
class _State extends State<ManageBodies> {
  @override
                ...
                child: Wrap(
                  ...
                  children: [
                    Container(
                      ...
                      child: StreamBuilder(
                        stream: FirebaseFirestore.instance.collection("ProductBodyMaster")
                                                ...
                                                child: Stack(
                                                  children: <Widget>[
                                                    Pinned.fromSize(
                                                      ...
                                                      fixedHeight: true,
                                                      child: Text(
                                                        snapshot.data.documents[index].get('bodyName'),
                                                        style: TextStyle(
                                                          fontFamily: 'Poppins',
                                                          fontSize: 14,
                                                          color: const Color(0xff000000),
                                                    ...
                                                    Pinned.fromSize(
                                                      bounds: Rect.fromLTWH(5.0, 25.0, 46.0, 21.0),
                                                      size: Size(56.0, 45.0),
                                                      pinLeft: true,
                                                      pinRight: true,
                                                      pinBottom: true,
                                                      fixedHeight: true,
                                                      child: Text(
                                                        snapshot.data.documents[index].get('bodyNameInTamil'),
                                                        style: TextStyle(
                                                          fontFamily: 'Poppins',
                                                          fontSize: 13,
                                                    ...
                                                    Pinned.fromSize(
                                                      bounds: Rect.fromLTWH(5.0, 50.0, 46.0, 21.0),
                                                      size: Size(56.0, 45.0),
                                                      pinLeft: true,
                                                      pinRight: true,
                                                      pinBottom: true,
                                                      fixedHeight: true,
                                                      child: Text(
                                                        snapshot.data.documents[index].get('classSize'),
                                                        style: TextStyle(
                                                          fontFamily: 'Poppins',
                                                          fontSize: 13,
                                                          color: const Color(0x8f000000),
                                                    ...
                                                    Pinned.fromSize(
                                                      ...
                                                      GestureDetector(
                                                        onTap: () {
                                                          print("Edit");
                                                          Navigator.of(context).push(MaterialPageRoute(
                                                              builder: (_) => ManageBodiesEditButton(id:snapshot.data.documents[index].get('userId'),productName: snapshot.data.documents[index].get('bodyName'),productNameInTamil: snapshot.data.documents[index].get('bodyNameInTamil'),classSize: snapshot.data.documents[index].get('classSize'),)));
                                                        },
                                                        child: SvgPicture.string(
                                                          _svg_amx086,
                                                          allowDrawingOutsideViewBox: true,
                                                          ...
                                                          showDialog(
                                                            ...
                                                            builder: (context) {
                                                              return AlertDialog(
                                                                ...
                                                                content: Text('Do you want to delete '+snapshot.data.documents[index].get('bodyName'),style: TextStyle(color: Colors.red),),
                                                                actions: <Widget>[
                                                                  FlatButton(
                                                                    child: Text('No'),
                                                                    onPressed: () {
                                                                  ...
                                                                  FlatButton(
                                                                    ...
                                                                    onPressed: () {
                                                                      print("delete");
                                                                      FirebaseController.instanace.productBodyMasterDelete( snapshot.data.documents[index].get('userId')).then((data) async {
                                                                        print(data);
                                                                        if(data==null){
