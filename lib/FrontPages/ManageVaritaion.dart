...
import 'package:kvmaster/EditButtonPages/ManageVariationEditButton.dart';
import 'package:kvmaster/OnButtonClickPages/ManageVariationButton.dart';


class ManageVaritaion extends StatefulWidget {
  ManageVaritaion({
    Key key,
  }) : super(key: key);
...
class _State extends State<ManageVaritaion> {
  @override
                      ...
                      child:
                        ...
                        fit: BoxFit.fill,
                           ...
                           onPressed: (){
                              ...
                              builder: (_) => ManageVariationButton()));        
                         }),),
                ...
                child: Wrap(
                  ...
                  children: [
                    Container(
                      ...
                      child: StreamBuilder(
                        stream: FirebaseFirestore.instance.collection("ProductVariationMaster")
                                                ...
                                                child: Stack(
                                                  children: <Widget>[
                                                    Pinned.fromSize(
                                                      ...
                                                      fixedHeight: true,
                                                      child: Text(
                                                        snapshot.data.documents[index].get('variationName'),
                                                        style: TextStyle(
                                                          fontFamily: 'Poppins',
                                                          fontSize: 14,
                                                          color: const Color(0xff000000),
                                                    ...
                                                    Pinned.fromSize(
                                                      ...
                                                      fixedHeight: true,
                                                      child: Text(
                                                        snapshot.data.documents[index].get('groupName'),
                                                        style: TextStyle(
                                                          fontFamily: 'Poppins',
                                                          fontSize: 13,
                                                    ...
                                                    Pinned.fromSize(
                                                      bounds: Rect.fromLTWH(5.0, 44.0, 46.0, 21.0),
                                                      size: Size(56.0, 45.0),
                                                      pinLeft: true,
                                                      pinRight: true,
                                                      pinBottom: true,
                                                      fixedHeight: true,
                                                      child: Text(
                                                        snapshot.data.documents[index].get('size'),
                                                        style: TextStyle(
                                                          fontFamily: 'Poppins',
                                                          fontSize: 13,
                                                          color: const Color(0x8f000000),
                                                    ...
                                                    Pinned.fromSize(
                                                      ...
                                                      GestureDetector(
                                                        onTap: () {
                                                          print("Edit");
                                                          Navigator.of(context).push(MaterialPageRoute(
                                                              builder: (_) => ManageVariationEditButton(id:snapshot.data.documents[index].get('userId') ,variationName: snapshot.data.documents[index].get('variationName'),size: snapshot.data.documents[index].get('size'),selected: snapshot.data.documents[index].get('groupName'),)));
                                                        },
                                                        child: SvgPicture.string(
                                                          _svg_amx086,
                                                          allowDrawingOutsideViewBox: true,
                                                          ...
                                                          showDialog(
                                                            ...
                                                            builder: (context) {
                                                              return AlertDialog(
                                                                ...
                                                                content: Text('Do you want to delete '+snapshot.data.documents[index].get('groupName'),style: TextStyle(color: Colors.red),),
                                                                actions: <Widget>[
                                                                  FlatButton(
                                                                    child: Text('No'),
                                                                    onPressed: () {
                                                                  ...
                                                                  FlatButton(
                                                                    ...
                                                                    onPressed: () {
                                                                      ...
                                                                      print("delete");
                                                                      FirebaseController.instanace.productVariationMasterDelete( snapshot.data.documents[index].get('userId')).then((data) async {
                                                                        print(data);
                                                                        if(data==null){
