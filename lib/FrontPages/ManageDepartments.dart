...
import 'package:kvmaster/EditButtonPages/ManageDepartmentEditButton.dart';
import 'package:kvmaster/OnButtonClickPages/ManageDepartmentButton.dart';
...
class _State extends State<ManageDepartments> {
  @override
                      ...
                      child:
                        ...
                        fit: BoxFit.fill,
                           ...
                           onPressed: (){
                              ...
                              builder: (_) => ManageDepartmentButton()));
                ...
                child: Wrap(
                    ...
                    children: [
                      Container(
                          ...
                          child: StreamBuilder(
                            stream: FirebaseFirestore.instance.collection("ProductDepartmentMaster")
                                              ...
                                              children: <Widget>[
                                                ...
                                                Transform.translate(
                                                  ...
                                                  child: SizedBox(
                                                    width: 67.0,
                                                    child: Text(
                                                      snapshot.data.documents[index].get('departmentName'),
                                                      style: TextStyle(
                                                        fontFamily: 'Poppins',
                                                        fontSize: 14,
                                                        color: const Color(0xff000000),
                                                ...
                                                Transform.translate(
                                                  ...
                                                  child: SizedBox(
                                                    width: 67.0,
                                                    child: Text(
                                                      snapshot.data.documents[index].get('departmentNameInTamil'),
                                                      style: TextStyle(
                                                        fontFamily: 'Poppins',
                                                        fontSize: 13,
                                                        color: const Color(0xff000000),
                                                ...
                                                Transform.translate(
                                                  offset: Offset(49.4, 90.0),
                                                  child: SizedBox(
                                                    width: 67.0,
                                                    child: Text(
                                                      snapshot.data.documents[index].get('group'),
                                                      style: TextStyle(
                                                        fontFamily: 'Poppins',
                                                        fontSize: 12,
                                                        color: const Color(0xff000000),
                                                        ...
                                                        Pinned.fromSize(
                                                          ...
                                                          GestureDetector(
                                                            onTap: (){
                                                              print("Edit");
                                                              Navigator.of(context).push(MaterialPageRoute(
                                                                  builder: (_) => ManageDepartmentEditButton(id:snapshot.data.documents[index].get('userId') ,departmentName:snapshot.data.documents[index].get('departmentName')  ,departmentNameInTamil: snapshot.data.documents[index].get('departmentNameInTamil') ,group: snapshot.data.documents[index].get('group') ,wastage: snapshot.data.documents[index].get('wastage') ,)));
                                                            },
                                                              ...
                                                              showDialog(
                                                                ...
                                                                builder: (context) {
                                                                  return AlertDialog(
                                                                    ...
                                                                    content: Text('Do you want to delete '+snapshot.data.documents[index].get('departmentName'),style: TextStyle(color: Colors.red),),
                                                                    actions: <Widget>[
                                                                      FlatButton(
                                                                        child: Text('No'),
                                                                        onPressed: () {
                                                                      ...
                                                                      FlatButton(
                                                                        ...
                                                                        onPressed: () {
                                                                          print("delete");
                                                                          FirebaseController.instanace.productDepartmentMasterDelete( snapshot.data.documents[index].get('userId')).then((data) async {
                                                                            print(data);
                                                                            if(data==null){
