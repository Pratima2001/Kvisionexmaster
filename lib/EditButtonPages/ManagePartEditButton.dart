...
class ManagePartEditButton extends StatefulWidget {
  ManagePartEditButton({
    Key key,this.id,this.partName,this.partnameInTamil,this.department,this.weight,this.podiName,this.gattiRequired
  }) : super(key: key);


  String id;
  String partName;
  String partnameInTamil;
  String department;
  String weight;
  String podiName;
  String gattiRequired;

  @override
  _ManageProductPageButton1State createState() => _ManageProductPageButton1State();
}

class _ManageProductPageButton1State extends State< ManagePartEditButton> {
...
//                child: IconButton(icon: Icon(Icons.arrow_back,color: Colors.black,), onPressed: null)),
            ...
            Transform.translate(
              ...
              TextFormField(
                ...
                keyboardType: TextInputType.text,
                decoration: InputDecoration(
                  hintText: widget.partnameInTamil,
                  hintStyle: TextStyle(fontSize: 14),
                  border: InputBorder.none,
                ),
              ),
                        ...
                        children: <Widget>[
                          Pinned.fromSize(
                            ...
                            child: GestureDetector(
                              onTap: (){
                                print("save");
                                FirebaseController.instanace.productPartMasterEdit(widget.id,_partName.text,_partNameInTamil.text,_department,_weight.text,_podiName,_gattiRequired.text,selectedValue).then((data) async {
                                  print(data);
                                  if(data==null){
