...
class ManageBodiesEditButton extends StatefulWidget {
  ManageBodiesEditButton(
      {Key key,
      this.id,
      this.productName,
      this.productNameInTamil,
      this.classSize})
      : super(key: key);
...
class _State extends State<ManageBodiesEditButton> {
                        ...
                        children: <Widget>[
                          Pinned.fromSize(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                double clasSize =
                                    double.parse(_classSize.text.toString());
                                if (clasSize < 1) {
                                  print("save");
                                  FirebaseController.instanace
                                      .productBodyMasterEdit(
                                          widget.id,
                                          _productName.text,
                                          _productNameInTamil.text,
                                          _classSize.text)
                                      .then((data) async {
                                    print(data);
                                    if (data == null) {
